                ...
                <div class="col-lg-6 col-md-12">
                    <div class="room-card position-relative">
                        ...
                        <div class="room-card-body">
                            ...
                            <button class="btn btn-select-room" onclick="selectRoom('Regular', 15000)">Select Room</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="room-card position-relative">
                        ...
                        <div class="room-card-body">
                            ...
                            <button class="btn btn-select-room" onclick="selectRoom('Standard', 25000)">Select Room</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="room-card position-relative">
                        ...
                        <div class="room-card-body">
                            ...
                            <button class="btn btn-select-room" onclick="selectRoom('Deluxe', 35000)">Select Room</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="room-card position-relative">
                        ...
                        <div class="room-card-body">
                            ...
                            <button class="btn btn-select-room" onclick="selectRoom('Executive', 45000)">Select Room</button>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-md-6">
                                <div class="room-card-body h-100 d-flex flex-column">
                                    ...
                                    <button class="btn btn-select-room mt-3" onclick="selectRoom('Luxury', 50000)">Select Room</button>
                                </div>
                            </div>
                        </div>
                    </div>
